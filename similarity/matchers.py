...
class PairwiseMatcher(BaseMatcher):
    ...
    def preprocess(self, text):
        ...
        if self.text_normalization == 'fast_lemmatize_filter_pos':
            text = basic_nlu.fast_normalize(text, lemmatize=True, filter_pos=True)
    ...
    def compare_two(self, text1, text2):
        return self.compare(self.preprocess(text1), self.preprocess(text2))
